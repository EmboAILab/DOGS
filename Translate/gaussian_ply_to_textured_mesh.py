#!/usr/bin/env python3
"""
Convert a Gaussian-splat PLY into a continuous textured mesh for simulator-side inspection.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create a continuous textured FBX from Gaussian PLY.")
    parser.add_argument("input", nargs="?", default="assets/point_cloud.ply")
    parser.add_argument("--fbx", default="assets/dogs/PointCloudObject_TexturedMesh.fbx")
    parser.add_argument("--texture", default="assets/dogs/T_PointCloudObject_TexturedMesh_BaseColor.png")

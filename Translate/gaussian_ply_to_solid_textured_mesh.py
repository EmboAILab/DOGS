#!/usr/bin/env python3
"""
Create a solid continuous mesh proxy from a Gaussian-splat PLY.
...
- transfer color for optional textured-mesh inspection.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create a solid simulator mesh proxy from Gaussian PLY.")
    parser.add_argument("input", nargs="?", default="assets/point_cloud.ply")
    parser.add_argument("--fbx", default="assets/dogs/PointCloudObject_SolidTexturedMesh.fbx")
    parser.add_argument("--texture", default="assets/dogs/T_PointCloudObject_SolidTexturedMesh_BaseColor.png")

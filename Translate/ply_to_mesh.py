...
For Isaac Sim / Isaac Lab interface checks, use this mesh as a geometric or
collision-proxy carrier, and keep the original Gaussian USDZ as the visible
asset when exact appearance matters. Contact behavior and physical parameters
remain simulator-side settings.
"""

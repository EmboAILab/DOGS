...
Example:
    python Translate/run_3dgrut_usdz_collision_pipeline.py \
        path/to/object_or_scene/point_cloud.ply
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("input_ply", help="Input DOGS object/background/composed Gaussian PLY.")

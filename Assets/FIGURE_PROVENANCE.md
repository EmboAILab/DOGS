...
The submitted DOGS figures use three source classes:
...
The project-page virtual gallery uses twelve downsampled, metadata-stripped looping clips extracted from the same class of source simulation recordings. These presentation derivatives expose no source filename, episode identifier, local path, or embedded camera metadata.
